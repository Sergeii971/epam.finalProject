...
### Общее описание<a name="общее_описание"></a> 
  ...
  После подтверждения заказа, автомобиль доставляется в точку выдачи и пользователю приходит на электоронную почту письмо о том, что его заказ прибыл. 
  После оплаты администратор помечяет сделку как состоявшуюся.
...
### Пользователи<a name="пользователи"></a> 
  ...
  * **Клиент**  
    У клиента в свою очередь определены шесть статусов: **активирован, неавктивирован, Заблокированный, разблокированный, является администратором или нет**.  
    Клиенту, прошедшему процедуру регистрации присваивается роль **Клиент** и статус **Ожидающий активации**. На электронную почту клиента, указанную при регистрации, отправляется
    письмо с кодом подтверждения, введя который его статус меняется на **Активирован**. В случае нарушения клиентом правил пользования магазином администратор может его заблокировать,
    статус с **Разблокированный** сменится на **Заблокированный**.  
    ...
    Функциональные возможности:
      ...
      * **Заблокированный** 
        ...
        * Смена языка сайта 
  * **Администратор**  
    Управляет работой магазина. В его обязанности входит добавление новых автомобилей в каталог, управление автомобилями,
...
### Автомобили<a name="автомобили"></a>   
  ...
  Так же каждому автомобилю присвоена стоимость и флаг - доступен он для заказа клиентами или нет.  
  
[⬆️Оглавление](#оглавление)
___
### Заказы<a name="заказы"></a>   
  Результатом заказа автомобиля клиентом является заказ. 
  Заказ содержит информацию об автомобиле и клиенте, заказавшем его, а также дате появления.  
  
  Заказу присваивается один из двух статусов:
  * **В обработке**  
  Присваивается новому заказу после его оформления клиентом
  * **Выполненный**
  После оплаты клиентом статус заказа с в обработке меняется на Выполненный
  
  В случаях, когда:
  * Заказ выполнен, но не был оплачен
...
# Online store selling cars "<a name="Russian"> </a>
---
### Java Web Development Teaching Project
### Author: Verbovsky Sergey
#### [Go to EN](#english)
---
